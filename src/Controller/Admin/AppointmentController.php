...
class AppointmentController extends AbstractController
{
    ...
    public function index(AppointmentRepository $appointmentRepository, EntityManagerInterface $entityManager): Response
    {
        ...
        $therapists = $entityManager->getRepository(User::class)
            ...
            ->getQuery()
            ->getResult();
        return $this->render('panel/appointments.html.twig', [
    ...
    #[Route('/new/{therapist}', name: 'panel_appointment_new', methods: ['GET', 'POST'])]
    #[IsGranted('ROLE_USER')]
    public function new(Request $request, User $therapist, AvailabilityRepository $availabilityRepository, EntityManagerInterface $entityManager): Response
    {
        $user = $this->getUser();
        if ($user === $therapist) {
        ...
        return $this->render('panel/appointment_new.html.twig', [
            'therapist' => $therapist,
    ...
    #[Route('/{id}', name: 'panel_appointment_show', methods: ['GET'])]
    #[IsGranted('ROLE_USER')]
    public function show(Appointment $appointment): Response
    {
        ...
        return $this->render('panel/appointment_show.html.twig', [
            'appointment' => $appointment,
        ]);
    }

    #[Route('/{id}/cancel', name: 'panel_appointment_cancel', methods: ['POST'])]
    #[IsGranted('ROLE_USER')]
